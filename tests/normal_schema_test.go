...
func TestNormalSchema(t *testing.T) {
	...
	mainSuccessInput3 := normalSchemaInput{`3`, `"abc"`, LARGE_BYTE, `-1`, `5`, `-1.23`, `"false"`, `"abc"`}
	mainSuccessExpected3 := normalSchemaExpected{3, "abc", LARGE_BYTE_EXPECTED_OUTPUT, -1, 5, -1.23, false, "abc"}
	...
	mainSuccessInput5 := normalSchemaInput{`5`, SPECIAL_CHAR, `"001"`, `0`, `5`, `1.234567111111111`, `"True"`, SPECIAL_CHAR}
	mainSuccessExpected5 := normalSchemaExpected{5, SPECIAL_CHAR_EXPECTED_OUTPUT, []byte{0x30, 0x30, 0x31}, 0, 5, 1.234567111111111, true, SPECIAL_CHAR_EXPECTED_OUTPUT}
	NormalSchemaTransformTest(t, testSourceSchema, transformer, mainSuccessInput5, mainSuccessExpected5)

	mainSuccessInput6 := normalSchemaInput{`6`, LARGE_STRING, `""`, `-1`, `0`, `1.7976931348623157e+308`, `"False"`, `""`}
	mainSuccessExpected6 := normalSchemaExpected{6, LARGE_STRING_EXPECTED_OUTPUT, []byte{}, -1, 0, 1.7976931348623157e+308, false, ""}
	...
	mainSuccessInput11 := normalSchemaInput{`11`, SPECIAL_CHAR, `" "`, `0`, `5`, `-1.23`, `"0"`, `null`}
	mainSuccessExpected11 := normalSchemaExpected{11, SPECIAL_CHAR_EXPECTED_OUTPUT, []byte{0x20}, 0, 5, -1.23, false, nil}
	NormalSchemaTransformTest(t, testSourceSchema, transformer, mainSuccessInput11, mainSuccessExpected11)

	mainSuccessInput12 := normalSchemaInput{`12`, LARGE_STRING, LARGE_BYTE, `-1`, `0`, `-1.234567111111111`, `"1"`, `""`}
	mainSuccessExpected12 := normalSchemaExpected{12, LARGE_STRING_EXPECTED_OUTPUT, LARGE_BYTE_EXPECTED_OUTPUT, -1, 0, -1.234567111111111, true, ""}
...
func TestNormalSchemaErrorHandle(t *testing.T) {
	...
	extensionOneInput3 := normalSchemaInput{`3`, `5`, SPECIAL_CHAR, `"abc"`, `"abc"`, `"abc"`, `"abc"`, `""`}
	extensionOneExpected3 := normalSchemaExpected{3, "5", SPECIAL_CHAR_EXPECTED_BYTE_OUTPUT, 0, 0, 0, false, ""}
	...
	extensionOneInput5 := normalSchemaInput{`5`, `5`, `"10102"`, SPECIAL_CHAR, SPECIAL_CHAR, SPECIAL_CHAR, SPECIAL_CHAR, `""`}
	...
	extensionOneInput6 := normalSchemaInput{`6`, `5`, `101`, LARGE_STRING, LARGE_STRING, LARGE_STRING, LARGE_STRING, `""`}
	...
	extensionOneExpected9 := normalSchemaExpected{9, "5", SPECIAL_CHAR_EXPECTED_BYTE_OUTPUT, 1, 1, 0, false, ""}
